...
const ServicesContext = ({
  ...
  return (
    <div data-aos='fade-left' id="xidmetlerimiz" className="bg-[#210442] w-full xl:px-12 rounded-xl lg:px-28 md:px-12 3 lg:mb-0 xl:my-6 lg:my-0 md:my-16 sm:my-8 text-[#fff]">
